<footer class="zerogrid">
      ...
      <div class="col-1-3">
        <div class="wrap-col">
          ...
          <div class="row">
            ...
            <h5>Nick Roach</h5>
            <p>Pellentesque elementum leo et justo dapibus convalli. In justo nibh, congue nec dapibus ac, placerat
              eget sem. Nunc consequat felis non elit ultricies in varius massa laoreet. Aenean lectus nisl,
              ellentesque in fermentum sit amet, convallis a lorem condimentum mollis. Aenean lectus nisl,
              ellentesque in fermentum sit amet.</p>
          </div>
        </div>
      </div>
      <div class="col-1-3">
  ...
  <div class="copyright">
    <div class="wrapper">
      <?php echo $theme_options["copy_right"]["text"] ?>
      <a href="https://www.developergoutam.com">
        <?php echo $theme_options["copy_right"]["link"] ?> </a>
