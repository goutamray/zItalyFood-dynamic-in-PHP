    ...
    <ul class="rslides"
      ...
      <li>
        ...
        <div class="caption">
          ...
          <p>At vero eos et accusam et justo duo dolores et ea rebum. Consetetur sadipscing elitr, sed diam nonumy
              ...
              <div class="wrap-col">
                <div class="box-item">
                  ...
                  <img src="images/menu.jpg"
                    alt="">
                  <p>The sliding menucard will surely impress your customers! Set up several pages and display them
                    side by side, just as on a paper menucard!</p>
                  <a href="#"
                    class="button button-1">Detail</a>
                </div>
              </div>
            </div>
            <div class="col-1-3">
